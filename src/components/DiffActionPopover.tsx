  ...
  return createPortal(
    ...
    >
      ...
      <span className="diff-action-popover__label">
        <span className="diff-action-popover__label-dot" aria-hidden="true" />
        {label}
      </span>
      <button
        type="button"
        className="diff-action-popover__button diff-action-popover__button--main"
        title={actionTitle}
      ...
      >
        ...
        <span className="diff-action-popover__button-text">
          {ignored ? i18n.diffNavigator.unignoreHere : i18n.diffNavigator.ignoreHere}
        </span>
      </button>
      {!ignored && similarCount > 0 && (
        <button
          type="button"
          className="diff-action-popover__button diff-action-popover__button--similar"
