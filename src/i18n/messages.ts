...
const en = {
  ...
  header: {
    ...
    showDiffMapTitle: 'Show a compact overview of difference positions between the documents.',
  ...
  imagePreview: {
    ...
    actualSizeHint: 'Toggle actual size and fit',
    fit: 'Fit',
    ...
    resetHint: 'Clear rotation and flips, then fit the image',
    linked: 'Linked',
    unlinked: 'Unlinked',
    linkViews: 'Link image controls',
    linkHint: 'Match zoom and position while keeping each orientation, then adjust both together',
    unlinkHint: 'Turn off, then select an image to adjust it independently',
    keyboardHint:
      'Arrow keys pan, + and − zoom, 0 fits, 1 shows actual size, R and Shift+R rotate, H and V flip, and Home resets the view.',
...
const zhCN: I18nMessages = {
  ...
  header: {
    ...
    showTableHints: '结构标记',
    showDiffMapTitle: '在两份文档之间显示差异位置概览',
    showDiffMap: '差异地图',
  ...
  imagePreview: {
    ...
    flipVertical: '垂直翻转',
    resetView: '还原初始视图',
    resetHint: '清除旋转和翻转，并适应窗口',
    linked: '联动',
    unlinked: '独立',
    linkViews: '联动图片操作',
    linkHint: '对齐缩放和位置，保留各自方向，并联动后续操作',
    unlinkHint: '关闭后，点击图片即可单独调整',
    keyboardHint: '方向键移动，+ 和 − 缩放，0 适应窗口，1 原始尺寸，R 和 Shift+R 旋转，H 和 V 翻转，Home 还原视图。',
    loading: '正在加载图片…',
